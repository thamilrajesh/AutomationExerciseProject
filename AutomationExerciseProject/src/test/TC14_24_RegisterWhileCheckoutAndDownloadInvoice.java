...
public class TC14_24_RegisterWhileCheckoutAndDownloadInvoice extends BrowserLaunchAndClose{
	...
	@Test(priority = 2)
    public void verifyPlaceOrderanddownloadInvoice() {
		product.AddProduct();
	    ...
	    checkoutPay.clickDownloadInvoice();
	    Assert.assertTrue(checkoutPay.isFileDownloaded("C:\\Users\\Thamil\\Downloads\\","invoice.txt"),"Failed to download Expected document");
